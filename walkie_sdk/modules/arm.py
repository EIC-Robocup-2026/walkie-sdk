...
MOVEIT_ACTION_INTERFACE = ARM_ACTIONS["interface"]
...
class Arm:
    ...
    def control_gripper(
        ...
        Args:
            group_name: MoveIt planning group name (e.g., "left_gripper").
            position: Gripper position (0.7 = closed, -15.71 = open).
            blocking: Wait for action to complete (default: True).
